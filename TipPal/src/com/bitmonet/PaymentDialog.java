...
public class PaymentDialog extends Dialog {
	...
	private void updateDialogLayout() {
		...
		TextView wallet = (TextView) findViewById(com.tippal.app.R.id.wallet);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.tippal.app.R.layout.dialog_payment_layout);
		...
		// Set the item
		mItemText = (TextView) findViewById(com.tippal.app.R.id.item);
		mItemText.setText(mItem);

		// Set the amount
		mPriceText = (TextView) findViewById(com.tippal.app.R.id.price);
		mPriceText.setText(getSymbol(mCurrency) + " " + String.valueOf(mAmount));

		// Set the listener
		mBuyButton = (Button) findViewById(com.tippal.app.R.id.buyButton);
		mBuyButton.setOnClickListener(onClickListener);
		
		mProgressBar = (ProgressBar) findViewById(com.tippal.app.R.id.transactionProgressBar);
		mProcessingTransaction = (TextView) findViewById(com.tippal.app.R.id.processingTransaction);
		mTransactionResult = (TextView) findViewById(com.tippal.app.R.id.transactionResult);
	}
