...
public class CoinbaseWebView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.tippal.app.R.layout.webview_coinbase_webview);
		webView = (WebView) findViewById(com.tippal.app.R.id.coinbseWebview);
	...
	private void showLoadingSpinner() {
		findViewById(com.tippal.app.R.id.spinnerWebView).setVisibility(View.VISIBLE);
		findViewById(com.tippal.app.R.id.loadingText).setVisibility(View.VISIBLE);
	}

	private void hideLoadingSpinner() {
		findViewById(com.tippal.app.R.id.spinnerWebView).setVisibility(View.GONE);
		findViewById(com.tippal.app.R.id.loadingText).setVisibility(View.GONE);
	}
